...
import FieldCard from "@/components/inspector/FieldCard.vue";
import { useInspectionStore } from "@/store";
import { storeToRefs } from "pinia";

const inspectionStore = useInspectionStore();
const { isInspector, isComplex, currentField, documentType } =
...
<template>
  ...
  >
    ...
    <section :class="fields.layout" aria-label="키 밸류">
      ...
      <FieldCard :types="documentType" :items="currentField || []" />
    </section>
  </article>
</template>
